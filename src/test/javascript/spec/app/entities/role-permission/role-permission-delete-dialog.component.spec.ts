...
import { RolePermissionDeleteDialogComponent } from 'app/entities/role-permission/role-permission-delete-dialog.component';
  ...
  describe('RolePermission Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [RolePermissionDeleteDialogComponent],
      })
