...
describe('Service Tests', () => {
  describe('RolePermission Service', () => {
    ...
    let elemDefault: IRolePermission;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(RolePermissionService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new RolePermission(0, 0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a RolePermission', () => {
        ...
        service.create(new RolePermission()).subscribe(resp => (expectedResult = resp.body));
